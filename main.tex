...
\begin{document}
    \name{John Doe}
    \tagline{\en{Test Developer}\sv{Testutvecklare}}
    ...
    \personalinfo{
        ...
        \location{\en{City, Country}\sv{Stad, Land}}\\
    ...
    \begin{paracol}{2}
        ...
        \cvsection{\en{Languages}\sv{Språk}}
            \cvlang{\en{Lang 1}\sv{Språk 1}}{\en{Native}\sv{Modersmål}}\\
            \medskip
            
            \cvlang{\en{Lang 2}\sv{Språk 2}}{\en{Proficient / C2}\sv{Flytande / C2}}
        ...
        \cvsection{\en{References}\sv{Referenser}}
            \linkedin{Ref 1}{ref-1}
            \medskip
            
            \linkedin{Ref 2}{ref-2}
            \medskip
            
            \linkedin{Ref 3}{ref-3}
            \smallskip
        % ----- REFERENCES -----
        ...
        \cvsection{\en{Experience}\sv{Erfarenhet}}
            \cvevent{\en{Charge}\sv{Befattning}}{| \en{Company}\sv{Företag}}{Mm YYYY -- Mm YYYY}{\en{City, Country}\sv{Stad, Land}}
            \en{
                \begin{itemize}
                    \item First item
                    \item Second item
        ...
        \cvsection{\en{Education}\sv{Utbildning}}
            \cvevent{\en{Title}\sv{Titel}}{| Institution}{Mm YYYY -- Mm YYYY}{\en{City, Country}\sv{Stad, Land}}
            \en{
            ...
            \sv{
                Gick på \link{Universitet}{https://universitet.se}
                \smallskip
                \begin{itemize}
                    \item Betygssnitt: 1,23
                \end{itemize}
            }
            \divider
